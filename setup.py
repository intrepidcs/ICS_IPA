...
if py_minor is 7:
    if platform.system() == 'Windows' and platform.architecture()[0] == '32bit':
        os.symlink("./ICS_IPA/_DataFileIOLibraryInterface-py3.7-v4.12-32.pyd", "./ICS_IPA/_DataFileIOLibraryInterface.pyd")
    elif platform.system() == 'Windows' and platform.architecture()[0] == '64bit':
        os.symlink("./ICS_IPA/_DataFileIOLibraryInterface-py3.7-v4.12-64.pyd", "./ICS_IPA/_DataFileIOLibraryInterface.pyd")
    else:
        raise "Platform or python version is not supported"
elif py_minor is 6:
    if platform.system() == 'Windows' and platform.architecture()[0] == '32bit':
        os.symlink("./ICS_IPA/_DataFileIOLibraryInterface-py3.6-v4.12-32.pyd", "./ICS_IPA/_DataFileIOLibraryInterface.pyd")
    elif platform.system() == 'Windows' and platform.architecture()[0] == '64bit':
        os.symlink("./ICS_IPA/_DataFileIOLibraryInterface-py3.6-v4.12-64.pyd", "./ICS_IPA/_DataFileIOLibraryInterface.pyd")
    elif platform.system() == 'Linux' and platform.architecture()[0] == '64bit':
        os.symlink("./ICS_IPA/_DataFileIOLibraryInterface-py3.6-v4.12-64.so", "./ICS_IPA/_DataFileIOLibraryInterface.so")
    else:
        raise "Platform or python version is not supported"
elif py_minor is 4:
    if platform.system() == 'Linux' and platform.architecture()[0] == '64bit':
        os.symlink("./ICS_IPA/_DataFileIOLibraryInterface-py3.4-v4.12-64.so", "./ICS_IPA/_DataFileIOLibraryInterface.so")
    else:
        raise "Platform or python version is not supported"
else:
