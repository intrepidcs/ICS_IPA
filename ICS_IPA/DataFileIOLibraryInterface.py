...
if __package__ or "." in __name__:
    from . import _DataFileIOLibraryInterface
else:
...
def GetChannels(pDataFile, pJsonFile):
    return _DataFileIOLibraryInterface.GetChannels(pDataFile, pJsonFile)

def GetChannelStatistics(pDataFile, pJsonFile):
    return _DataFileIOLibraryInterface.GetChannelStatistics(pDataFile, pJsonFile)
